...
# Le code PPV_opt.c correspond à la méthode du plus proche voisin amélioré
...
# Le programme random.h est une fonction que l'on nous a donné en cours pour générer des nombres aléatoires
